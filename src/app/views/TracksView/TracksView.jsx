        ...
        return (
            <div className='main'>
                <div className='tracks-list'>
                    <h2>Essas são as músicas mais ouvidas por você</h2>
                ...
                title={"Esses são os artistas das músicas mais ouvidas por você"}
                desc={"Foi feito uma contagem dos artistas que estão nesse conjunto de músicas"}/>
                <div className='basic-table'>
                ...
                title={"Esses são os albuns das músicas mais ouvidas por você"}
                desc={"Foi feito uma contagem de quais albuns estão nesse conjunto de músicas"}/>
                <PieChart data={tracks.additional.decades.count} 
                title={"Essas são as décadas das músicas mais ouvidas por você"}/>
                ...
                desc={"Essa é uma medida de 0 a 1 que diz quanto uma música é acústica ou não. Quanto mais próxima de 1 mais acústica a música é"}/>
                <BarChart data={tracks.features.danceability} 
                title={"Aqui está quanto suas músicas são dançáveis"}
                desc={"Essa é uma medida de 0 a 1 que diz quanto uma música é dançável ou não. Quanto mais próxima de 1 mais dançável a música é"}/>
                <BarChart data={tracks.features.energy} 
                title={"Aqui está quanto suas músicas são enérgicas e intensivas"}
                desc={"Essa é uma medida de 0 a 1 e representa quanto uma música é intensiva. Músicas mais enérgicas tendem a ser mais rápidas, altas e barulhentas. Quanto mais próximo de 1 mais enérgica a música é"}/>
